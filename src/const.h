...
enum TextColor_t : uint8_t {
	...
	TEXTCOLOR_EARTH_DAMAGE = 121,
	TEXTCOLOR_NONE = 255,
	
    // Added elements
    TEXTCOLOR_NORMAL = 86,       // Dark Gray
    TEXTCOLOR_FIRE = 198,         // Orange ok
    TEXTCOLOR_WATER = 23,         // Cyan ok
    TEXTCOLOR_ELECTRIC = 210,     // Yellow ok
    TEXTCOLOR_GRASS = 66,         // Light Green ok
    TEXTCOLOR_ICE = 71,          // Light Cyan ok
    TEXTCOLOR_FIGHTING = 86,     // Dark Red ok
    TEXTCOLOR_POISON = 83,       // roxo OK
    TEXTCOLOR_GROUND = 126,       // Brown ok
    TEXTCOLOR_FLYING = 143,        // Light Blue OK ?
    TEXTCOLOR_PSYCHIC = 113,      // roxo ok
    TEXTCOLOR_BUG = 97,           // Olive Green Ok
    TEXTCOLOR_ROCK = 86,          // Dark Gray ok?
    TEXTCOLOR_GHOST = 74,        // red-dark ok
    TEXTCOLOR_DRAGON = 181,        // red-littledark
    TEXTCOLOR_DARK = 38,         // dark purple ok
    TEXTCOLOR_STEEL = 129,         // Light Gray
    TEXTCOLOR_FAIRY = 203,        // Light Pink ok
};
...
static constexpr int32_t FLY_STORAGE = 5001;
