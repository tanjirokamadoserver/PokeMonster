...
local mType = Game.createMonsterType("Dragon Machamp")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Arm Thrust", power = 5, interval = 40000},
    {name = "Vacuum Wave", power = 5, interval = 45000},
    {name = "Dynamic Punch", power = 5, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Arm Thrust", power = 5, interval = 40000, chance = 100},
    {name = "Vacuum Wave", power = 5, interval = 45000, chance = 100},
    {name = "Dynamic Punch", power = 5, interval = 50000, chance = 100},
