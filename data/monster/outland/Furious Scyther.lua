...
local mType = Game.createMonsterType("Furious Scyther")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Shredder Team", power = 5, interval = 30000},
    {name = "Air Slash", power = 9, interval = 40000},
    {name = "Agility", power = 5, interval = 30000},
    {name = "Team Slice", power = 5, interval = 6000},
...
pokemon.attacks = {
    ...
    {name = "Shredder Team", power = 5, interval = 30000, chance = 100},
    {name = "Air Slash", power = 9, interval = 40000, chance = 100},
    {name = "Agility", power = 5, interval = 30000, chance = 100},
    {name = "Team Slice", power = 5, interval = 6000, chance = 100},
