...
local mType = Game.createMonsterType("Ancient Kingdra")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Liquidation", power = 5, interval = 35000},
    {name = "Brine", power = 5, interval = 32000},
    {name = "Water Pulse", power = 5, interval = 25000},
    {name = "Dragon Pulse", power = 5, interval = 50000},
    {name = "Twister", power = 5, interval = 40000},
    {name = "Surf", power = 5, interval = 70000},
    {name = "Endure", power = 5, interval = 70000},
...
pokemon.attacks = {
    ...
    {name = "Liquidation", power = 5, interval = 35000, chance = 100},
    {name = "Brine", power = 5, interval = 32000, chance = 100},
    {name = "Water Pulse", power = 5, interval = 25000, chance = 100},
    {name = "Dragon Pulse", power = 5, interval = 50000, chance = 100},
    {name = "Twister", power = 5, interval = 40000, chance = 100},
    {name = "Surf", power = 5, interval = 70000, chance = 100},
    {name = "Endure", power = 5, interval = 70000, chance = 100},
