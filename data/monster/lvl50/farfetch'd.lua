...
local mType = Game.createMonsterType("Farfetch'D")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Farfetch'D"
...
pokemon.moves = {
    ...
    {name = "Stickmerang", power = 7, interval = 30000},
    {name = "Stickslash", power = 7, interval = 25000},
    {name = "Stick Throw", power = 7, interval = 15000},
    {name = "Night Slash", power = 15, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Stickmerang", power = 7, interval = 30000, chance = 100},
    {name = "Stickslash", power = 7, interval = 25000, chance = 100},
    {name = "Stick Throw", power = 7, interval = 15000, chance = 100},
    {name = "Night Slash", power = 15, interval = 30000, chance = 100},
