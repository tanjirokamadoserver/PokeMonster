...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_ROCKDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Meteor Beam")
...
-- Configure the spell
targetSpellTeste:name("Meteor Beam")
targetSpellTeste:words("###Meteor Beam###")
