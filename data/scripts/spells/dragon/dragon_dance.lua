...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_DRAGONDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Dragon Dance")
...
-- Configure the spell
targetSpellTeste:name("Dragon Dance")
targetSpellTeste:words("###Dragon Dance###")
