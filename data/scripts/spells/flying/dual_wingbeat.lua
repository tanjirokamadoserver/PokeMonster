...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_FLYINGDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Dual Wingbeat")
...
-- Configure the spell
targetSpellTeste:name("Dual Wingbeat")
targetSpellTeste:words("###Dual Wingbeat###")
