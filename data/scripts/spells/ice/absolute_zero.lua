...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_ICEDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Absolute Zero")
...
-- Configure the spell
targetSpellTeste:name("Absolute Zero")
targetSpellTeste:words("###Absolute Zero###")
