...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_WATERDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Origin Pulse")
...
-- Configure the spell
targetSpellTeste:name("Origin Pulse")
targetSpellTeste:words("###Origin Pulse###")
