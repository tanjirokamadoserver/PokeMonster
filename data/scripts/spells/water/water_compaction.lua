...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_ELECTRICDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Water Compaction")
...
-- Configure the spell
targetSpellTeste:name("Water Compaction")
targetSpellTeste:words("###Water Compaction###")
