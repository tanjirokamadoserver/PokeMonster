...
combat1:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Octazooka")

local condition = createConditionObject(CONDITION_SILENCE)
condition:setParameter(CONDITION_PARAM_TICKS, 6000)
condition:setParameter(CONDITION_PARAM_EFFECT_TICKS, 1000)
condition:setParameter(CONDITION_PARAM_EFFECT, 315)
...
spell:name("Octazooka")
spell:words("### Octazooka ###")
