...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_GHOSTDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Dark Accurate")
...
-- Configure the spell
targetSpellTeste:name("Dark Accurate")
targetSpellTeste:words("###Dark Accurate###")
