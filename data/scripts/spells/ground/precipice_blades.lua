...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_GROUNDDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Precipice Blades")
...
-- Configure the spell
targetSpellTeste:name("Precipice Blades")
targetSpellTeste:words("###Precipice Blades###")
