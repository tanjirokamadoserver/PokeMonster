...
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Fake Tears")
...
local function rotation_ring(parameters)
    ...
    if gir_table_up[parameters.n] ~= nil and gir_table_down[parameters.n] then
        ...
        addEvent(rotation_ring, parameters.delay, {
            ...
            gir_table_up = gir_table_up,
            gir_table_down = gir_table_down
        })
    end
end
...
function spell.onCastSpell(creature, variant)
    ...
    -- Anel Interno
    rotation_ring({
        gir_table_up = { 0, 3, 4, 1, 2, 5, 1, 1, 7, 0, 0, 6, 3, 3, 4, 2, 2, 5, 1, 1, 7, 0, 0, 6, 3 },
        gir_table_down = { 2, 1, 7, 1, 0, 6, 3, 3, 4, 2, 2, 5, 1, 1, 7, 0, 0, 6, 3, 3, 4, 2, 2, 5, 1 },
        delay = 200,
        n = 1,
        cid = creatureId,
        topPos = { x = 0, y = 0, z = 0 },
...
spell:name("Fake Tears")
spell:words("#Fake Tears#")
