...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_STEELDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Iron Spinner")
...
-- Configure the spell
targetSpellTeste:name("Iron Spinner")
targetSpellTeste:words("###Iron Spinner###")
