...
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Flame Circle")
...
local function rotation_ring(parameters)
    ...
    if parameters.n > parameters.totalMoves then
        return -- Para a execução se a volta completa foi alcançada
    end
...
spell:name("Flame Circle")
spell:words("#Flame Circle#")
