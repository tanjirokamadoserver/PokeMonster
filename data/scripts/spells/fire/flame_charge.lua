...
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_FIREDAMAGE) --a que colocar o nome maiusculo da title antes do DAMAGE exemplo COMBAT_NOMETITLEDAMAGE
combat:setParameter(COMBAT_PARAM_EFFECT, 46)
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Flame Charge")
...
-- Configure the spell
targetSpellTeste:name("Flame Charge")
targetSpellTeste:words("###Flame Charge###")
