...
combat:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Leaf Tornado")
...
function spell.onCastSpell(creature, variant)
    -- local withFocus = 0
    -- if creature:hasCondition(CONDITION_FOCUS) then
    --     creature:getPosition():sendMagicEffect(133)
    --     creature:removeCondition(CONDITION_FOCUS)
    --     withFocus = 1
    -- end
    -- combat:setParameter(COMBAT_PARAM_WITHFOCUS, withFocus)
...
spell:name("Leaf Tornado")
spell:words("#Leaf Tornado#")
