...
local MISSILE_ID = 111
local EFFECT_ID = 2388

local combat1 = createCombatObject()
combat1:setParameter(COMBAT_PARAM_TYPE, COMBAT_GRASSDAMAGE)
combat1:setArea(createCombatArea(AREA_BURST))
combat1:setStringParameter(COMBAT_PARAM_STRING_SPELLNAME, "Petal Bullets")
...
spell:name("Petal Bullets")
spell:words("### Petal Bullets ###")
